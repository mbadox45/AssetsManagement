    ...
    <div class="grid">
        ...
        <div class="col-12 md:col-12">
            <div class="card">
                ...
                <!-- Datatable -->
                <div class="grid">
                    <div class="col-12" v-if="listAdjustment.length > 0">
                        <DataTable v-model:filters="filters" :value="listAdjustment" paginator showGridlines :rows="10" dataKey="id"
                            filterDisplay="menu" :loading="loading" :globalFilterFields="['kode_loss', 'nama_loss', 'kode_margin', 'nama_margin']">
                            <template #header>
